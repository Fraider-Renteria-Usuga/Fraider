import math
def Biseccion(X1,X2,Tolerancia,Nmax):
  if X1==X2:
    ...
    print("No fue posible ejecutar el programa ya que el numero maximo de iteracciones debe ser mayor a 0")
  else:
    ...
    if Fx1==0:
      ...
      print("el intervalo es inadecuado ya que en este no se encuentra ninguna raiz")
Biseccion(0,0,1e-7,31)